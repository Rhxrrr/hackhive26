...
function buildWavBlob(chunks: Uint8Array[], minBytes = TONE_MIN_PCM_BYTES): Blob | null {
...
export default function LiveCallPage() {
  ...
  const stopCall = () => {
    ...
    const file = wavBlob ? new File([wavBlob], `call-${callId}.wav`, { type: "audio/wav" }) : undefined;
    addCall({
      id: callId,
      date: dateStr,
      agent: "Agent",
