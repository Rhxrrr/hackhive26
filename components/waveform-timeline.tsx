  ...
  return (
    <div className="space-y-4">
          ...
          >
            ...
            {marker.type === "bad" && (
              <div className="flex flex-col items-center">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" className="text-destructive rotate-180">
                  <path
                    fill="currentColor"
                    d="M12 4L4 14h16L12 4z"
                  />
      ...
      <div className="flex items-center gap-6 text-xs">
        ...
        <div className="flex items-center gap-2">
          <svg width="16" height="16" viewBox="0 0 24 24" className="text-destructive rotate-180">
            <path fill="currentColor" d="M12 4L4 14h16L12 4z" />
          </svg>
